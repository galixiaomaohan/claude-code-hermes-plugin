...
import { Document, DocumentCreateParams, DocumentDeleteResponse, DocumentListParams, DocumentQueryParams, DocumentQueryResponse, DocumentUpdateParams, Documents, DocumentsPage, PageDocument } from "./documents.js";
...
export declare class Collections extends APIResource {
     ...
     */
    create(appId: string, userId: string, body: CollectionCreateParams, options?: Core.RequestOptions): Core.APIPromise<Collection>;
    /**
     * Update a Collection's name or metadata
     */
    update(appId: string, userId: string, collectionId: string, body: CollectionUpdateParams, options?: Core.RequestOptions): Core.APIPromise<Collection>;
    /**
     * Get All Collections for a User
     */
    list(appId: string, userId: string, params?: CollectionListParams, options?: Core.RequestOptions): Core.PagePromise<CollectionsPage, Collection>;
    list(appId: string, userId: string, options?: Core.RequestOptions): Core.PagePromise<CollectionsPage, Collection>;
    /**
     * Delete a Collection and its documents
     */
    delete(appId: string, userId: string, collectionId: string, options?: Core.RequestOptions): Core.APIPromise<unknown>;
    /**
     ...
     */
    get(appId: string, userId: string, query?: CollectionGetParams, options?: Core.RequestOptions): Core.APIPromise<Collection>;
    get(appId: string, userId: string, options?: Core.RequestOptions): Core.APIPromise<Collection>;
    /**
     * Get a Collection by Name
     */
    getByName(appId: string, userId: string, name: string, options?: Core.RequestOptions): Core.APIPromise<Collection>;
}
export declare class CollectionsPage extends Page<Collection> {
}
