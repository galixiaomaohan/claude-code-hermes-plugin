...
import { App, AppCreateParams, AppGetParams, AppListParams, AppUpdateParams, Apps, AppsPage, PageApp } from "./resources/apps/apps.js";
 ...
 */
export declare class Honcho extends Core.APIClient {
    apiKey: string | null;
    private _options;
    /**
     * API Client for interfacing with the Honcho API.
    ...
    static Honcho: typeof Honcho;
    static DEFAULT_TIMEOUT: number;
    static HonchoError: typeof Errors.HonchoError;
...
export declare namespace Honcho {
    ...
    export { Apps as Apps, type App as App, type PageApp as PageApp, AppsPage as AppsPage, type AppCreateParams as AppCreateParams, type AppUpdateParams as AppUpdateParams, type AppListParams as AppListParams, type AppGetParams as AppGetParams, };
