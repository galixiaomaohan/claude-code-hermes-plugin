...
exports.MetamessagesPage = exports.Metamessages = void 0;
const resource_1 = require("../../../resource.js");
const core_1 = require("../../../core.js");
const pagination_1 = require("../../../pagination.js");
class Metamessages extends resource_1.APIResource {
    /**
     ...
     */
    update(appId, userId, metamessageId, body, options) {
     ...
     */
    get(appId, userId, metamessageId, options) {
        return this._client.get(`/v1/apps/${appId}/users/${userId}/metamessages/${metamessageId}`, options);
    }
}
exports.Metamessages = Metamessages;
class MetamessagesPage extends pagination_1.Page {
}
exports.MetamessagesPage = MetamessagesPage;
Metamessages.MetamessagesPage = MetamessagesPage;
//# sourceMappingURL=metamessages.js.map