...
function setShims(shims, options = { auto: false }) {
    if (exports.auto) {
        throw new Error(`you must \`import 'honcho-ai/shims/${shims.kind}'\` before importing anything else from honcho-ai`);
    }
    if (exports.kind) {
        throw new Error(`can't \`import 'honcho-ai/shims/${shims.kind}'\` after \`import 'honcho-ai/shims/${exports.kind}'\``);
    }
